...
keymap.set('n', '<leader>dd', ":DapTerminate<CR>", {noremap=true})
keymap.set('n', '<leader>dr', function() require('dapui').open{reset = true} end, {noremap=true})
keymap.set('n', '<leader>du', function() require('dapui').toggle() end, {noremap=true})
